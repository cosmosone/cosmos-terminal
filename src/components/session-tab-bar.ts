...
import { addSession, removeSession, removeProject, setActiveSession, setActiveTab, removeContentTab, closeOtherTabs, splitPane, renameSession, setFileTabEditing, toggleSessionLocked, toggleFileTabLocked } from '../state/actions';
...
import { fileIcon, lockIcon } from '../utils/icons';
